...
const translations = {
  ...
  si: {
    ...
    // FULLY TRANSLATED VARIETY DETAILS
    varietyDetails: {
      dingirala: {
        name: "ඩිංගි රාළ",
        parentage: "දෙමුහුම: පන්නියූර්-1 × GK 49\n\nමෙම දෙමුහුම් ප්‍රභේදය ඉහළ අස්වැන්නක් ලබා දෙන පන්නියූර්-1 සහ ශ්‍රී ලංකාවේ ගුණාත්මක ලක්ෂණ සඳහා ප්‍රසිද්ධ GK 49 යන ප්‍රභේදවල ජාන එකතු කරයි.",
        agronomy: "කරලක දිග: ~12 සෙ.මී.\nපිරුම් ප්‍රතිශතය: ~80%\nවාර්ෂික අස්වැන්න: වැලකට ග්‍රෑම් ~2245\n\nමෙම අගයන් මගින් ඉහළ නිෂ්පාදන ධාරිතාවක් සහ හොඳ තත්ත්වයේ කරල් සැකැස්මක් පෙන්නුම් කරයි.",
        quality: "ඔලියෝරෙසින්: ~12.9%\nතෙල්: ~2.8%\nපයිපරින්: ~5.6%\n\nගම්මිරිස්වලට සැර ගතිය ලබා දෙන ප්‍රධාන සංයෝගය පයිපරින් වන අතර, ඩිංගි රාළ සතුව සැලකිය යුතු සැර ගතියක් ඇත.",
        summary: "ඩිංගි රාළ යනු හොඳ අස්වැන්නක් සහ ගුණාත්මක බවක් ලබා දෙන, වගාකරුවන් සඳහා විශ්වාසදායක සමබර දෙමුහුම් ප්‍රභේදයකි."
      },
      bootawe: {
        name: "බූටාවේ රාළ",
        parentage: "දෙමුහුම: පන්නියූර්-1 × DM 7\n\nමෙම දෙමුහුම් ප්‍රභේදය පන්නියූර්-1 සහ දේශීය තේරීමක් වන DM 7 සමඟ එකතු වී නිර්මාණය වී ඇත.",
        agronomy: "කරලක දිග: ~14 සෙ.මී. (අනෙක් ඒවාට වඩා දිගු)\nපිරුම් ප්‍රතිශතය: ~80%\nවාර්ෂික අස්වැන්න: වැලකට ග්‍රෑම් ~2724\n\nමෙම අගයන්ට අනුව ප්‍රධාන දෙමුහුන් වර්ග තුන අතරින් ඉහළම අස්වැන්නක් ලබා දෙන්නේ බූටාවේ රාළ ය.",
        quality: "ඔලියෝරෙසින්: ~12.9%\nතෙල්: ~3.1%\nපයිපරින්: ~6.3%\n\nබූටාවේ රාළ සතුව ඉහළ තෙල් සහ පයිපරින් ප්‍රතිශතයක් ඇති අතර, එමගින් වියළි ගම්මිරිස්වල ප්‍රබල සුවඳක් සහ සැරක් ලබා දෙයි.",
        summary: "ඉහළ අස්වැන්නක් සහ ප්‍රබල කුළුබඩු ලක්ෂණ නිසා බූටාවේ රාළ බොහෝ විට වාරික (Premium) තේරීමක් ලෙස සැලකේ."
      },
      kohu: {
        name: "කොහුකුඹුරේ රාළ",
        parentage: "දෙමුහුම: MW 21 × පන්නියූර්-1\n\nදේශීය වගා තත්වයන් යටතේ ක්‍රියාකාරිත්වය වැඩි දියුණු කිරීම සඳහා මෙය දේශීය තේරීමක් (MW 21) සහ පන්නියූර්-1 භාවිතා කර නිපදවා ඇත.",
        agronomy: "කරලක දිග: ~12 සෙ.මී.\nපිරුම් ප්‍රතිශතය: ~80%\nවාර්ෂික අස්වැන්න: වැලකට ග්‍රෑම් ~2340\n\nඅස්වැන්න අනුව මෙය අනෙක් ප්‍රභේද දෙක අතර මැද අගයක් ගනී.",
        quality: "ඔලියෝරෙසින්: ~15.4%\nතෙල්: ~3.6%\nපයිපරින්: ~6%\n\nමෙහි ඇති ඉහළ ඔලියෝරෙසින් සහ තෙල් අන්තර්ගතය නිසා සකසන ලද ගම්මිරිස් නිෂ්පාදනවල රසය සහ සුවඳ වැඩි දියුණු කරයි.",
        summary: "කොහුකුඹුරේ රාළ යනු හොඳ අස්වැන්නක් සහ ඉහළ ඔලියෝරෙසින් අන්තර්ගතයක් සහිත සමබර දෙමුහුම් ප්‍රභේදයකි."
      }
    }
  },
};
